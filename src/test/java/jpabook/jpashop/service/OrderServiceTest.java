...
class OrderServiceTest {
	...
	public void 상품주문() throws Exception {
		...
		assertThat(getOrder.getStatus()).as("상품 주문시 상태는 ORDER").isEqualTo(OrderStatus.ORDER); //상품 주문시 상태는 ORDER
	...
	public void 상품주문_재고수량초과() throws NotEnoughStockException {
		...
		//then
		assertThat(exception).isInstanceOf(NotEnoughStockException.class).hasMessageContaining("need");
		// assertThatThrownBy(() -> {
		// 	orderService.order(member.getId(), item.getId(), orderCount);
